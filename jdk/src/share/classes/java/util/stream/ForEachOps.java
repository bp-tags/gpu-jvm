...
final class ForEachOps {
    ...
    static abstract class ForEachOp<T>
        ...
        static boolean supportsForEachOffload() {
            return (SumatraUtils.getOffload());
        }
        ...
        private <S> void parallelForEachOffloadable(Spliterator sp,
                                                    PipelineHelper<T> helper,
                                                    Sink<S> sink) {
            if (supportsForEachOffload()) {
                ...
                PipelineInfo.offloadForEachPipeline(sp, helper, sink, this);
            } else {
