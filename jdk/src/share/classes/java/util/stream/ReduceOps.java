...
final class ReduceOps {
    ...
    makeInt(int identity, IntBinaryOperator operator) {
        ...
        return new ReduceOp<Integer, Integer, ReducingSink>(StreamShape.INT_VALUE) {
            ...
            @Override
            public Integer evaluateOffloadableIntReduce(PipelineHelper<Integer> helper,
                    Spliterator<Integer> spliterator, String reducerName, int identity) {
                Spliterator sp = PipelineInfo.offloadableSpliterator(spliterator);
                if (sp != null) {
                    return PipelineInfo.offloadReducePipeline(sp, helper, makeSink(), this, reducerName, identity);
                } else {
